...
export default function RoutineAnalytics() {
  ...
  const loadData = async () => {
    try {
      ...
      // ========================================
      // ROUTINE / ODD ONE OUT RESULTS
      // ========================================

      const routineResults = Array.isArray(analytics?.routine)
        ? analytics.routine
        : [];

      const patientResults = routineResults.filter(
      ...
      console.error("Routine analytics error:", err);
      ...
      <section className="analytics-section">
        ...
        {results.length === 0 ? (
          <div className="empty-state">
            ...
            <h3>No Odd One Out sessions yet</h3>

            <p>
              Once the patient plays Odd One Out, their performance will appear
              here.
            </p>
          </div>
        ) : (
